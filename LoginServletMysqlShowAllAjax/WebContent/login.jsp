...
<html>
    ...
    -->
     ...
     function aaa() {
    	 ...
    	 if(x=="")
 			...
 			xmlhttp.open("post","Serverajax",true);
 			xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
 			xmlhttp.send("username="+username);
 			//悲惨，用post发送解没问题，用get发送就是不知到怎么把参数传递过去！！
  ...
  <body>
     ...
     <center>                        <!-- 下面这种跳转方式比较清晰靠谱 -->
         <form method="post" action="http://localhost/LoginServletMysqlShowAllAjax/LoginServlet" onSubmit="return login(this);">
